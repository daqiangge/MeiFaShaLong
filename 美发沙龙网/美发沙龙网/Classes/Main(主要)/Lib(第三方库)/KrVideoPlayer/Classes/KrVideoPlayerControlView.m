...
- (UIButton *)backButton
{
    if (!_backButton)
    {
        ...
        [_backButton setImage:[UIImage imageNamed:@"videoPlayer_back"] forState:UIControlStateNormal];
        _backButton.bounds = CGRectMake(0, 0, kVideoControlBarHeight*2, kVideoControlBarHeight);
    }
    return _backButton;
}
